      ...
      <div className="z-50 absolute top-4 left-4">
        ...
        >
          <div className="bg-gradient-to-br from-amber-900/30 via-amber-800/20 to-amber-700/30 backdrop-blur-md rounded-lg border border-amber-700/40 shadow-2xl h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[70vh] max-h-[500px] sm:max-h-[600px] md:max-h-[700px] overflow-hidden flex flex-col">
            {/* Header */}
            <div className="flex items-center gap-1.5 sm:gap-2 p-2 border-b border-amber-700/30 bg-gradient-to-r from-amber-800/40 to-amber-700/40 flex-shrink-0">
              <div className="p-1 bg-gradient-to-br from-yellow-600/80 to-yellow-700/80 rounded-md shadow-md border border-yellow-500/50">
                <Trophy className="w-3 h-3 text-yellow-200" />
              </div>
              <div className="min-w-0 flex-1">
                <h2 className="text-sm font-bold text-amber-100 drop-shadow-lg truncate">
                  Leaderboard
                </h2>
            ...
            <div className="p-2 sm:p-3 overflow-y-auto flex-1 wood-scrollbar">
              {isLoading ? (
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-32">
                  <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-amber-300"></div>
                </div>
              ) : isError ? (
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-32 text-amber-200/80 text-sm">
                ...
                <div className="space-y-1 sm:space-y-1.5">
                  {leaderBoardData.data.data.map((player, index) => (
                    <div
                      ...
                      className={`
                        flex items-center justify-between p-1.5 sm:p-2 rounded-md transition-all duration-300 hover:-translate-y-0.5
                    ...
                    >
                      <div className="flex items-center gap-1 sm:gap-1.5 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1 mb-0.5">
                            <User className="w-2 h-2 sm:w-2.5 sm:h-2.5 text-amber-300/80 flex-shrink-0" />
                            <h3 className="font-semibold text-amber-100 truncate text-xs drop-shadow-md">
                              {player.username}
                            </h3>
                          </div>
                      ...
                      <div className="text-right flex-shrink-0 ml-1">
                        <div className="text-sm font-bold text-amber-100 drop-shadow-lg">
            ...
            {/* Pagination Footer */}
            <div className="flex-shrink-0 border-t border-amber-700/30 bg-gradient-to-r from-amber-800/40 to-amber-700/40 p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className={`
                      flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-md transition-all duration-200
                      ${
